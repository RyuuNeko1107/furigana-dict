...
| **熟語** (`core/jukugo/*`、手動 PR メンテ) | **4,616** | **193 KB** |
...
| `core/jukugo/general.toml` | 783 | 24 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
...
| **小計** | **48,926** | **1.02 MB** | (jukugo: 24 ファイル / **4,616 件** / 193 KB ・ works: 1 ファイル / **72 件** / 4.7 KB) |
